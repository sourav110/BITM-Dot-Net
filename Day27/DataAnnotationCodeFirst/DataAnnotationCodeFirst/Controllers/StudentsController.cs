...
using DataAnnotationCodeFirst.Models;

namespace DataAnnotationCodeFirst.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StudentId,StudentName,RegNo,Age,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
